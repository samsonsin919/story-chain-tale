    ...
    <div className="min-h-screen">
      ...
      <div className="mx-auto max-w-2xl px-4 sm:px-6 py-8 sm:py-14 mb-20 sm:mb-0">
        ...
        <form onSubmit={submit} className="cinema-card p-5 sm:p-7 space-y-6">
              ...
              {EMOJIS.map((e) => (
                <button
                  ...
                  className={`w-10 h-10 rounded-xl text-xl border transition ${
                    emoji === e ? "border-[color:var(--glow)] bg-white/5" : "border-white/10 hover:border-white/30"
                  }`}
                >
                  {e}
                </button>
          ...
          <div>
            <label className="text-xs tracking-[0.18em] uppercase text-muted-foreground">開場第一段</label>
            <textarea
              required
              maxLength={300}
              rows={5}
